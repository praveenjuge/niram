// Source: shadcn/ui v4 (apps/v4/registry + packages/shadcn/src/colors.ts).
// Stored as OKLCH strings — same format the shadcn registry returns at runtime.

import type { TailwindColorFamily, TailwindColorScale } from "./types";
